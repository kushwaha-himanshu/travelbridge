          ...
          <section className="relative overflow-hidden rounded-3xl bg-slate-900 border border-slate-800 flex flex-col justify-center min-h-[340px]">
            ...
            {!imageSrc && !isCameraActive && (
              ...
              <div
                ...
                className={`flex flex-col items-center justify-center p-8 text-center cursor-pointer min-h-[320px] transition ${isDragOver ? 'bg-blue-900/20 border-2 border-dashed border-blue-500' : 'bg-transparent border-0'
                  }`}
              >
                <input
                  type="file"
              ...
              {isCameraActive ? (
                <>
                  ...
                  <button
                    ...
                    className={`flex h-10 w-10 items-center justify-center rounded-full transition ${flashOn ? 'bg-amber-500 text-white' : 'text-slate-400 hover:bg-slate-850'
                      }`}
                  >
