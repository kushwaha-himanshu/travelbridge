        ...
        {/* Recording Visual Card */}
            ...
            {userAudioUrl && !isRecording && (
              <button
                ...
                className={`flex h-12 w-12 items-center justify-center rounded-full border shadow-sm transition hover:scale-105 ${
                  isPlayingUserAudio ? 'bg-rose-50 text-rose-600 border-rose-100' : 'bg-slate-50 text-slate-600 border-slate-200'
                }`}
